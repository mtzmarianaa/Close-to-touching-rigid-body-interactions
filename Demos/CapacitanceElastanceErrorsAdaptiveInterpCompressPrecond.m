...
% INTERPOLANTION, PRECONDITIONED COMPRESSED SYSTEM SOLVE
%clear all
%close all
clc
...
title("Errors on surface density - Interpolanted Compress Preconditioner")
xlabel("Distance between discs")
ylabel("Relative error (l2)")

figure()
loglog(xcoordCtr2-1.5, errors_ukAdaptive, '-o', 'Color', cq)
title("Errors on surface density (log log) - Interpolanted Compress Preconditioner")
xlabel("Distance between discs")
ylabel("Relative error (l2)")
...
title("Number of GMRES iterations needed - Capacitance - Interpolanted Compress Preconditioner")
xlabel("Distance between discs")
...
title("Number of GMRES iterations needed - Elastance - Interpolanted Compress Preconditioner")
xlabel("Distance between discs")
ylabel("GMRES iterations needed")
