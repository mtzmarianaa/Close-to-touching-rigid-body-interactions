...
% *prol_dyadic* Given 4 panels with k Legendre nodes each we build the
% prolongation matrix that maps those nodes to nodes on the finer
% discretization (dyadically refined towards the middle).
%
% Syntax: P = prol_dyadic( k, nRef )
%
% Input:
%   k - number of panels in the fine discretization
%   nRef - number of refinements needed
%
% Output:
%   P - prolongation matrix with the following structure size 4k x ( 2k + 2k(nRef + 1) )
%    I   0   0   0
%    0   P1  0   0
%    0   0   P2  0
%    0   0    0   I
